 ...
 * OTP Bing geocoder.
 */
@Path("/routers/{routerId}/googlegeocode")
@Produces(MediaType.APPLICATION_JSON)
public class GoogleGeocoderResource {

    private final GoogleGeocoder geocoder;

    public GoogleGeocoderResource (@Context OTPServer otpServer, @PathParam("routerId") String routerId) {
